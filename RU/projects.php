...
$siteStrings = array_merge($siteStrings, array(
	...
	'disMAEPara'		=> '<p>DisMAE, или Dischan Mobile Animation Engine, это кастомный движок для визуальных новелл для iOS созданный с помощью <a href = "http://www.cocos2d-iphone.org/" target="_blank">Cocos2D</a>.</p>
							...
							<br />
							<p>В данный момент, движок только для внутреннего использования, хотя может быть лицензирован в будущем.</p>',
	'juniperPara'	=> '<p>Juniper\'s Knot это короткая и бесплатная визуальная новелла созданная студией Dischan для NaNoReNo 2012 (NaNoReNo это ежегодный вызов по созданию визуальной новеллы в течение Марта).</p>
						<br />
