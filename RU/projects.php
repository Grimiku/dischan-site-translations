...
$siteStrings = array_merge($siteStrings, array(
	...
	'cradlePara'			=> '<p>Cradle Song это визуальная новелла над которой Dischan работает с момента её основания в 2009 году.</p>
							...
							<br />
							<p>В 2011 году, мы выпустили превью которое вы можете <a href = "http://cradle-song.com/download.php">загрузить</a> и попробовать. Трейлер можно найти ниже.</p>',
	'projectsPara'		=> '<p>В данный момент, главным проектом Dischan является визуальная новелла "Cradle Song". Пожалуйста посетите <a href = "projects.php?p=1">страницу Cradle Song</a> чтобы узнать больше.</p>
							<br />
