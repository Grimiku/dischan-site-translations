...
$siteStrings = array_merge($siteStrings, array(
	...
	'applyText'			=> 'Dischan никогда не закроет двери потенциальному таланту. Если вы думаете что достойны с нами работать, пожалуйста заполните анкету снизу. Убедитесь что вы заполнили все поля со звёздочкой иначе анкета не отправится! <br /><br /> Если вы хотите узнать какие вакансии у нас сейчас имеются, пожалуйста посетите страницу <a href = "positions.php">вакансий</a>.',
	'yourName'			=> 'Имя',
	'yourEmail'			=> 'E-Mail',
	...
	'aboutYou'			=> 'Расскажите немного о себе',
