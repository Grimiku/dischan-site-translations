...
'passwordIncorrect'			=> 'Hasło nieprawidłowe.',
	...
	'error'		=> 'Błąd!',
	'forumDoesNotExist'		=> 'Próbujesz pisać na forum, które nie istnieje.',
	'subConPicRequired'		=> 'Nowy wątek wymaga tematu, treści i obrazka.',
	'picConRequired'		=> 'Odpowiedź wymaga obrazka i/lub treści.',
	'threadLocked'				=> 'Nie możesz pisać. Wątek został zablokowany.',
	'fileUpError'			=> 'Wystąpił problem z załadowaniem pliku. Spróbuj ponownie.',
	'thumbProblem'			=> 'Wystąpił problem z wygenerowaniem miniaturki. Może spróbuj użyć innego obrazka?',
	'passwordNoMatch'		=> 'Twoje nowe hasła nie pasują.',
	'invalidEmail'			=> 'Nieprawidłowy adres email.',
	'postLimitReached'		=> 'Limit postów osiągnięty. Załóż inny wątek jeśli chcesz kontyunować dyskusję w tym temacie.',
	...
	'ipBannedMsg'			=> 'Twój adres IP został zbanowany. Być może to nie twoja wina, najpewniej spamer skłonił nas do wlepienia banu. Skontaktuj się z nami jeśli sądzisz, że to nie byłeś ty.',
